function metaForEach(opts, code) {
    ...
    var forAst = {loc:null, type:"Program", body:[{loc:null, type:"ExpressionStatement", expression:{loc:null, type:"CallExpression", callee:{loc:null, type:"FunctionExpression", id:null, params:[], defaults:[], body:{loc:null, type:"BlockStatement", body:[{loc:null, type:"ForInStatement", left:{loc:null, type:"Identifier", name:"k"}, right:meta_escape( false,collectionVar,false), body:{loc:null, type:"BlockStatement", body:[{loc:null, type:"ExpressionStatement", expression:{loc:null, type:"AssignmentExpression", operator:"=", left:{loc:null, type:"Identifier", name:"v"}, right:{loc:null, type:"MemberExpression", object:meta_escape( false,collectionVar,false), property:meta_escape( false,indexVar,false), computed:true}}}]}, each:false},{loc:null, type:"EmptyStatement"}]}, rest:null, generator:false, expression:false}, arguments:[]}}]};
    ...
    ++forPosInBody;
    var lastLoopVarfinal = {loc:null, type:"Program", body:[{loc:null, type:"IfStatement", test:{loc:null, type:"LogicalExpression", operator:"&&", left:{loc:null, type:"BinaryExpression", operator:"!==", left:{loc:null, type:"UnaryExpression", operator:"typeof", argument:{loc:null, type:"MemberExpression", object:meta_escape( false,collectionVar,false), property:{loc:null, type:"Identifier", name:"length"}, computed:false}, prefix:true}, right:{loc:null, type:"Literal", value:"undefined"}}, right:{loc:null, type:"BinaryExpression", operator:"==", left:meta_escape( false,indexVar,false), right:{loc:null, type:"BinaryExpression", operator:"-", left:{loc:null, type:"MemberExpression", object:meta_escape( false,collectionVar,false), property:{loc:null, type:"Identifier", name:"length"}, computed:false}, right:{loc:null, type:"Literal", value:1}}}}, consequent:{loc:null, type:"BlockStatement", body:[{loc:null, type:"ExpressionStatement", expression:{loc:null, type:"AssignmentExpression", operator:"=", left:{loc:null, type:"Identifier", name:"v"}, right:{loc:null, type:"Literal", value:true}}}]}, alternate:null},{loc:null, type:"EmptyStatement"}]};
