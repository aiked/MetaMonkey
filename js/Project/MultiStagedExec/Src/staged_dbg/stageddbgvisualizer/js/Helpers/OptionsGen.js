...
( function( root, factory ) {
	...
	if ( typeof define === 'function' && define.amd ) {
		define( [ 'underscore', 'jquery', 'bootstrap-slider', 'exports' ], function( _, $, Slider, exports ) {
			// Export global even in AMD case in case this script is loaded with
			// others that may still expect a global ast traverse.
			root.Ast = root.Ast || {};
			return root.Ast.OptionsGen = exports = factory( root, _, $, Slider );
		} );
	...
	// Next for Node.js or CommonJS.
		...
		root.Ast.OptionsGen = factory( root, root._, $, Slider );
	}

}( this, function( global, _, $, Slider ) {
