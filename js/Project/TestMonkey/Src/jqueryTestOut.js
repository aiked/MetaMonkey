...
, rtrim = {}, rmsPrefix = {}, rdashAlpha = {}, fcamelCase = function (all, letter) {
...
;
    jQuery.extend({expando: "jQuery" + (version + Math.random()).replace({}, ""),isReady: true,error: function (msg) {
    throw new Error(msg);
}
,noop: function () {
}
...
,is: function (selector) {
    ...
    var rootjQuery, document = window.document, rquickExpr = {}, init = jQuery.fn.init = function (selector, context) {
    var match, elem;
    if (!selector) {
    return this;
    }
...
;
    ...
    var rparentsprev = {}, guaranteedUnique = {children: true,contents: true,next: true,prev: true};
...
());
    var rformElems = {}, rkeyEvent = {}, rmouseEvent = {}, rfocusMorph = {}, rtypenamespace = {};
    function returnTrue() {
    return true;
    }
...
,triggerHandler: function (type, data) {
    ...
    var nodeNames = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|" + "header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", rinlinejQuery = {}, rnoshimcache = new RegExp("<(?:" + nodeNames + ")[\\s/>]", "i"), rleadingWhitespace = {}, rxhtmlTag = {}, rtagName = {}, rtbody = {}, rhtml = {}, rnoInnerhtml = {}, rchecked = {}, rscriptType = {}, rscriptTypeMasked = {}, rcleanScript = {}, wrapMap = {option: [1, "<select multiple='multiple'>", "</select>"],legend: [1, "<fieldset>", "</fieldset>"],area: [1, "<map>", "</map>"],param: [1, "<object>", "</object>"],thead: [1, "<table>", "</table>"],tr: [2, "<table><tbody>", "</tbody></table>"],col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"],td: [3, "<table><tbody><tr>", "</tr></tbody></table>"],_default: support.htmlSerialize?[0, "", ""]:[1, "X<div>", "</div>"]}, safeFragment = createSafeFragment(document), fragmentDiv = safeFragment.appendChild(document.createElement("div"));
...
());
    ...
    var getStyles, curCSS, rposition = {};
...
;
    var ralpha = {}, ropacity = {}, rdisplayswap = {}, rnumsplit = new RegExp("^(" + pnum + ")(.*)$", "i"), rrelNum = new RegExp("^([+-])=(" + pnum + ")", "i"), cssShow = {position: "absolute",visibility: "hidden",display: "block"}, cssNormalTransform = {letterSpacing: "0",fontWeight: "400"}, cssPrefixes = ["Webkit", "O", "Moz", "ms"];
...
,swing: function (p) {
    ...
    jQuery.fx.step = {};
    var fxNow, timerId, rfxtypes = {}, rfxnum = new RegExp("^(?:([+-])=|)(" + pnum + ")([a-z%]*)$", "i"), rrun = {}, animationPrefilters = [defaultPrefilter], tweeners = {"*": [function (prop, value) {
...
;
    ...
    support.style = {}.test(a.getAttribute("style"));
...
;
    ...
    var nodeHook, boolHook, attrHandle = jQuery.expr.attrHandle, ruseDefault = {}, getSetAttribute = support.getSetAttribute, getSetInput = support.input;
...
,attrHooks: {type: {set: function (elem, value) {
    ...
    jQuery.each(jQuery.expr.match.bool.source.match({}), function (i, name) {
...
;
    var ajaxLocParts, ajaxLocation, rhash = {}, rts = {}, rheaders = {}, rlocalProtocol = {}, rnoContent = {}, rprotocol = {}, rurl = {}, prefilters = {}, transports = {}, allTypes = "*/".concat("*");
    try {
...
;
    var r20 = {}, rbracket = {}, rCRLF = {}, rsubmitterTypes = {}, rsubmittable = {};
...
,serializeArray: function () {
    ...
    return (!this.isLocal && {}.test(this.type) && createStandardXHR() || createActiveXHR());
    }
:createStandardXHR;
...
,abort: function () {
    ...
    jQuery.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents: {script: {}},converters: {"text script": function (text) {
    ...
    if (isAbort || !script.readyState || {}.test(script.readyState)) {
