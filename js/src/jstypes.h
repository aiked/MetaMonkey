...
#ifdef	_MSC_VER
#pragma warning(disable : 4996)		// 'function': was declared deprecated also 'std::<function name>
#pragma warning(disable : 4800)		//  forcing value to bool 'true' or 'false' (performance warning)
#pragma warning(disable : 4099)		// '<id>' : type name first seen using 'class' now seen using 's
#pragma warning(disable : 4244)		// 'initializing' : conversion from 'const T' to 'T', possible loss of data
#pragma warning(disable : 4996)		// '<name>': This function or variable may be unsafe. Consider using <name'> instead.
#endif
