    ...
    switch (JSKW_LENGTH()) {
      ...
      case 7:
        switch (JSKW_AT(0)) {
          ...
          case 'p':
            if (JSKW_AT(1) == 'a') {
                JSKW_TEST_GUESS(37) /* package */
            }
            if (JSKW_AT(1) == 'r') {
                JSKW_TEST_GUESS(38) /* private */
            }
            JSKW_NO_MATCH()
        }
        JSKW_NO_MATCH()
      ...
      case 9:
        if (JSKW_AT(0) == 'i') {
            JSKW_TEST_GUESS(36) /* interface */
        }
        if (JSKW_AT(0) == 'p') {
            JSKW_TEST_GUESS(39) /* protected */
        }
        JSKW_NO_MATCH()
      case 10:
        if (JSKW_AT(1) == 'm') {
            JSKW_TEST_GUESS(35) /* implements */
        }
        if (JSKW_AT(1) == 'n') {
